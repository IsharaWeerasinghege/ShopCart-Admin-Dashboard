            ...
            <div className="flex flex-wrap lg:flex-nowrap justify-center">
                <div
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-2xl">$49,326.54</p>
                        </div>
                    </div>
                    <div className="mt-6">
                ...
                <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
                    {earningData?.map((item) => (<div
                            key={item.title}
                            className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg md:w-[10rem] p-4 pt-9 rounded-2xl"
                        >
                            <button
                                type="button"
                            ...
                            <div className="border-r-1 border-color m-4 pr-10">
                                <div>
                                    <p className="flex items-center">
                                        <span className="text-3xl font-semibold">$39.568</span>
