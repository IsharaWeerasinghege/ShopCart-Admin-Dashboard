...
const Chat = () => {
  ...
  return (
    <div className="nav-item bg-white absolute right-1 md:right-52 top-16 dark:bg-[#42464D] p-8 rounded-lg  w-[20rem] shadow-xl">
      ...
      <div className="mt-5 ">
        {chatData?.map((item, index) => (
            <div key={index} className="flex items-center gap-5 border-b-1 border-color p-3 leading-8 cursor-pointer">
              ...
              <div>
                <p className="font-semibold text-sm dark:text-gray-200 ">{item.message}</p>
